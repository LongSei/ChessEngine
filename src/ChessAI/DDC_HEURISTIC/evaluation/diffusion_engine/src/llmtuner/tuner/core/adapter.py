...
from evaluation.diffusion_engine.src.llmtuner.tuner.core.utils import find_all_linear_modules

if TYPE_CHECKING:
    from transformers.modeling_utils import PreTrainedModel
    from evaluation.diffusion_engine.src.llmtuner.hparams import ModelArguments, FinetuningArguments
...
def init_adapter(
    ...
    if finetuning_args.finetuning_type == "lora":
        ...
        if is_trainable and latest_checkpoint is None or stage == 'dm': # create new lora weights while training
