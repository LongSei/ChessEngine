...
from evaluation.diffusion_engine.src.llmtuner.extras.callbacks import LogCallback
from evaluation.diffusion_engine.src.llmtuner.extras.logging import get_logger
from evaluation.diffusion_engine.src.llmtuner.tuner.core import get_train_args, get_infer_args, load_model_and_tokenizer
import importlib
...
def run_exp(args: Optional[Dict[str, Any]] = None, callbacks: Optional[List["TrainerCallback"]] = None):
    ...
    if finetuning_args.stage == "sft":
        ...
        lib = importlib.import_module(f"evaluation.diffusion_engine.src.llmtuner.tuner.ddm.workflow")
        trainer_cls = importlib.import_module(f"evaluation.diffusion_engine.src.llmtuner.tuner.ddm.trainer")
