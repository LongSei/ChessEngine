...
import sys
sys.path.append("/content/drive/MyDrive/DISCRETE DIFFUSION CHESS/DiffuSearch/src")
datasets.utils.logging.set_verbosity_error()  # To suppress warnings
datasets.config.HF_DATASETS_CACHE="/content/datasets_cache" # change cache path
